          ...
          <section className="mx-auto grid max-w-6xl gap-10 px-5 py-20 md:grid-cols-[1.2fr_0.8fr] md:items-center md:py-28">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-stone-600">
                我協助學生、小型店家、個人品牌製作一頁式形象網站、作品集網站、
                活動頁與舊網站美化。適合預算有限，但想要有正式網站的客戶。
              </p>
            ...
            <div className="rounded-[2rem] border border-stone-200 bg-white p-6 shadow-sm">
              <div className="rounded-[1.5rem] bg-stone-950 p-6 text-white">
                ...
                <p className="mt-5 text-sm leading-7 text-stone-300">
                  以清楚資訊架構、RWD 手機版、快速上線為主，讓客戶能用合理預算得到正式網站。
                </p>
              </div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {item.link !== "#" ? (
                      ...
                      <span className="mt-5 inline-block rounded-full bg-stone-200 px-5 py-2 text-sm font-medium text-stone-500">
                        製作中
                      </span>
                    )}
                  </div>
