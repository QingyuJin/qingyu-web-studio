...
export const projects = [
  ...
  },
  {
    ...
    category: "後台系統",
    summary: "把工程行的客戶需求、現場照片、報價狀態、施工進度與 LINE 回報整理成一套後台流程。",
    featured: true,
    ...
    features: ["案件列表", "案件詳情", "照片 / 報價 Modal", "狀態管理", "LINE 回報 mock", "Dashboard 指標"],
    ...
    stack: {
      ...
      Future: "Supabase / LINE Messaging API / 報價單 PDF",
    },
