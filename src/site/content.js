...
export const projects = [
  {
    ...
    liveLabel: "查看 AI Demo",
    secondaryLabel: "技術拆解",
    tags: ["AI Analysis", "React", "Report UI", "Prompt Flow"],
    ...
    stack: {
      Frontend: "React / Tailwind 表單與報告 UI",
      Backend: "可延伸 Vercel API Route",
      API: "未來可接 OpenAI API 與 Prompt Flow",
      Database: "可儲存健檢紀錄與報告版本",
      Deploy: "Vercel 靜態部署",
    },
  ...
  },
  {
    ...
    liveLabel: "查看 LINE Bot Demo",
    secondaryLabel: "看流程",
    tags: ["LINE Messaging API", "Webhook", "Supabase", "Dashboard UI"],
    ...
    stack: {
      ...
      API: "LINE Messaging API / Reply flow",
