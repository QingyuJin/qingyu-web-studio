...
export const seo = {
  home: {
    path: "/",
    title: "Qingyu Web Studio｜AI 應用、互動式產品展示與店家自動化系統",
    description:
      "協助小型店家、工作室與工程行製作 AI 應用、互動式產品展示、LINE Bot、API 串接與自動化後台流程。",
  },
  works: {
    path: "/works",
...
export const projects = [
  {
    ...
    summary: "互動式 AI 產品展示遊戲，使用者可以體驗文件問答、模型分類、店家 AI 助手與產品展示室。",
    featured: true,
  ...
  },
  {
    ...
    demo: ["案件列表", "案件詳情", "照片 / 報價 / 狀態", "LINE 回報流程", "報價單預覽"],
