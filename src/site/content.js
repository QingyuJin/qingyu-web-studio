...
export const seo = {
  home: {
    ...
    description:
      "協助店家、公司、工作室與創作者，把網站、表單、商品、預約、LINE、自動回覆與資料管理，做成一套真的能用的成品。每個服務都有可點看的成品 Demo。",
  },
  works: {
    path: "/works",
...
export const pricingNote =
  "以上為素材齊全、需求明確、修改 1～2 次內的預估。實際價格會依頁數、功能、資料整理程度、修改次數與維護需求調整。網域、主機、付費外掛與第三方平台費用另計。"
