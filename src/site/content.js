...
export const projects = [
  {
    ...
    features: ["健檢表單", "AI 報告", "SEO 檢查", "CTA 建議", "Demo 模式"],
    architecture: ["React UI", "Vercel API", "OpenAI API", "Demo Data"],
    stack: {
  ...
  },
  {
    ...
    features: ["LINE 對話引導", "Webhook 接收", "AI / Demo 回覆", "後台收件匣", "案件狀態追蹤"],
    ...
    stack: {
      ...
      API: "LINE User → LINE Platform → /api/line-webhook → Signature Verify → OpenAI / Demo Reply → LINE Reply API → Dashboard Demo",
  ...
  },
  {
    ...
    stack: {
      ...
      Flow: "Frontend Form → REST API → 通知流程 → Dashboard UI",
      Fallback: "Demo Data",
    },
