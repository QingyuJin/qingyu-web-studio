    ...
    <>
      ...
      <header className={`site-header ${scrolled ? "site-header-scrolled" : ""}`}>
        ...
        <AnimatePresence>{megaOpen && <motion.div className="mega-menu desktop-only" initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}>
          ...
          <Link href="/products/nocturne-repair-serum" className="mega-feature"><span className="relative block h-full min-h-48 overflow-hidden"><Image src="/demo/morie/images/morie-collection.png" alt="夜間修護精華" fill sizes="28vw" className="object-cover" /></span><span><small>夜間儀式</small><strong>在夜色裡，讓肌膚慢慢回來</strong></span></Link>
