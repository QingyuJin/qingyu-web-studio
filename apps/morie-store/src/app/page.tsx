  ...
  return (
    <>
      <section className="hero">
        ...
        <div className="hero-visual"><Image src="/demo/morie/images/morie-hero.png" alt="琥珀瓶器、陶瓷罐與橄欖枝構成的 MORIÉ 品牌靜物" fill priority sizes="(max-width: 900px) 100vw, 51vw" /><span className="hero-caption">晨霧系列 · 2026</span></div>
      </section>

      <section className="story-feature">
        <div className="story-feature-image image-reveal"><Image src="/demo/morie/images/morie-collection.png" alt="MORIÉ 植萃保養瓶器系列" fill sizes="(max-width: 900px) 100vw, 50vw" className="object-cover" /></div>
      ...
      <section className="philosophy">
        ...
        <div className="philosophy-image image-reveal"><Image src="/demo/morie/images/morie-forest.png" alt="雨後山林、岩石與蕨類" fill sizes="(max-width: 900px) 100vw, 52vw" className="object-cover" /></div>
      </section>
