...
export default function StoryPage() {
  return <>
    <header className="story-hero"><div className="story-hero-copy"><p className="eyebrow">ABOUT MORIÉ</p><h1 className="editorial-title">在島嶼的濕度裡，<br />尋找照料的尺度。</h1><p>MORIÉ 誕生於一個簡單的問題：當生活已經足夠喧嘩，一款保養品還能否只做它真正需要做的事？</p></div><div className="story-hero-image"><Image src="/demo/morie/images/morie-forest.png" alt="雨霧中的台灣山林" fill priority sizes="100vw" className="object-cover" /></div></header>
    ...
    <section className="story-closing"><Image src="/demo/morie/images/morie-hero.png" alt="MORIÉ 晨光瓶器靜物" fill sizes="100vw" className="object-cover" /><div><p className="eyebrow">A QUIET INVITATION</p><h2>從一款真正需要的配方開始。</h2><Link href="/products" className="button-solid">探索 MORIÉ <ArrowRight size={16} /></Link></div></section>
  </>;
}
