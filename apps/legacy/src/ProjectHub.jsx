...
function ClientFeature({ item }) {
  return <article className="grid overflow-hidden rounded-[1.5rem] border border-[#cfd5cf] bg-[#fbfaf6] lg:grid-cols-[1.08fr_.92fr]"><Link to={item.casePath} className="block min-h-64 overflow-hidden bg-[#dfe6df]"><img src={item.image} alt="鑫匠工程網站與系統" width="1200" height="720" fetchPriority="high" className="h-full w-full object-cover" /></Link><div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10"><p className="text-[10px] font-semibold tracking-[.16em] text-[#557b72]">正式客戶專案</p><h3 className="mt-4 font-['Noto_Serif_TC',serif] text-3xl font-semibold tracking-[-.04em] text-[#12211f]">鑫匠工程</h3><p className="mt-4 text-sm font-medium leading-7 text-[#65716d]">把品牌介紹 線上詢價與工程案件管理串成一條流程</p><div className="mt-7 flex flex-wrap gap-3"><Link to="/works/xinjiang" className="inline-flex min-h-11 items-center rounded-full bg-[#173c37] px-5 text-xs font-bold text-white">查看案例</Link><Link to="/demo/buildflow" className="inline-flex min-h-11 items-center rounded-full border border-[#bcc6c0] px-5 text-xs font-bold text-[#29433e]">操作系統</Link></div></div></article>
}
