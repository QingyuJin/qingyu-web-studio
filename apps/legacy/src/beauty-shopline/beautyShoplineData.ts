...
export const cases = [
  {
    number: "CASE 01",
    title: "基礎護膚",
    text: "適合日常肌膚保養與定期護理。實際案例照片與顧客故事待客戶提供。",
    image: {
  ...
  },
  {
    number: "CASE 02",
    title: "問題肌管理",
    text: "依肌膚狀況提供適合的護膚方向。正式版將換入經授權的真實案例。",
    image: {
      src: "/beauty-preview/optimized/service-treatment.webp",
      width: 1600,
      height: 1067,
  ...
  },
  {
    number: "CASE 03",
    title: "客製化護膚",
    text: "依不同膚況規劃專屬流程。成效說明會以客戶確認的真實資料為準。",
    image: {
      src: "/beauty-preview/optimized/serum-ritual.webp",
      width: 1600,
      height: 1067,
...
export const policyDrafts = [
  ...
  },
  {
    ...
    title: "退換貨說明草稿",
    paragraphs: [
      "正式政策需依商品性質、包裝衛生、台灣消費者保護規範與品牌作業流程確認後發布。退貨期限、申請方式、例外項目、退款時間與運費負擔目前均待客戶核定。",
