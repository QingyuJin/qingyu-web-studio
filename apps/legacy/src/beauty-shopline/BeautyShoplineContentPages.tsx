  ...
  return (
    <>
      <InnerHero
        ...
        description="做臉護膚、問題肌管理與美容課程皆採預約制。正式服務名稱、時間與價格會在門市確認後集中替換。"
  ...
  return (
    <>
      <InnerHero
        ...
        description="目前只刊登已確認名稱與規格的商品。正式 SHOPLINE 串接後，價格、庫存、付款與物流會由商店系統管理。"
        image={imageAssets.ritual}
      />
      <section className="lf-inner-section">
        <div className="lf-shell">
          ...
          <DataStatus title="SHOPLINE 串接準備完成">
            商品資料已集中成可替換欄位。取得正式商店網址與完整商品資料後，可把詳情頁與購買按鈕改接
            SHOPLINE，不需重做版面。
          </DataStatus>
        </div>
      </section>
      ...
      <section className="lf-inner-section">
        <div className="lf-shell lf-policy-layout">
          <DataStatus title="重要：目前為待核定草稿">
            本預覽站沒有線上結帳，也不收集個人資料。以下內容不能替代正式法律文件，SHOPLINE
            開店設定與客戶核定後需再逐條更新。
          </DataStatus>
