...
function StudioHome() {
  ...
  return (
    <SiteLayout>
      ...
      <section className="bg-white"><div className="mx-auto grid max-w-7xl gap-8 px-5 py-16 sm:px-7 md:py-22 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-9"><img src={client.image} alt="鑫匠工程品牌網站畫面" width="1200" height="800" loading="lazy" className="aspect-[16/10] w-full rounded-2xl object-cover" /><div><span className="inline-flex rounded-full border border-[#aebdb7] px-3 py-1 text-[10px] font-semibold text-[#42675f]">正式客戶案例</span><h2 className="mt-5 font-['Noto_Serif_TC',serif] text-[clamp(1.8rem,4vw,3.2rem)] font-semibold tracking-[-.045em] text-[#14211f]">鑫匠工程</h2><p className="mt-4 max-w-xl text-sm font-medium leading-7 text-[#65716d]">品牌官網 線上詢價與案件後台串接 讓客戶入口與內部流程接在一起</p><Link to="/works/xinjiang" className="mt-7 inline-flex min-h-11 items-center rounded-full border border-[#b8c2bd] px-5 text-xs font-bold text-[#173c37]">查看完整案例</Link></div></div></section>
